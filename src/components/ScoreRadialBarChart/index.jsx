...
function ScoreRadialBarChart({ user }) {
	const scoreFormatted = [{ value: user.todayScore === undefined ? user.score * 100 : user.todayScore * 100, fill: colors.biaxialGraphBarsColor2 }];
		...
		<ScoreRadialBarChartWidget>
			<React.Fragment>
				...
				<ResponsiveContainer height="100%" width="100%">
					<RadialBarChart data={scoreFormatted} cx="50%" cy="50%" innerRadius={70} barSize={8} startAngle={-275} endAngle={95}>
